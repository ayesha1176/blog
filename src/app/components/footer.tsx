...
export default function footer () {
  ...
  <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
    <a className="flex title-font font-medium items-center md:justify-start justify-center text-red-900">
      ...
      <span className="ml-3 text-xl">Ayesha Rashid</span>
    </a>
    <p className="text-sm text-gray-900 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">© 2025 blog —
      <a href="https://twitter.com/blog" className="text-gray-600 ml-1" rel="noopener noreferrer" target="_blank">@Artificial Intelligence</a>
    </p>
