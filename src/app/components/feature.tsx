  ...
  return (
    <div>
      <section className="py-8 bg-neutral-100 mb-40">
        <h2
          className="text-center text-13xl font-bold md:text-5xl lg:text-left animate-fade-in-up transition-all duration-500 ease-in-out
        transform hover: translate-y[-5px] hover:text-black text-red-600"
        >
          Ayesha rashid: Nevagating the Secrets of Technology Blog !
        </h2>
        ...
        <div className="mx-auto max-w-7xl px-5">
          ...
          <div className="grid grid-cols-2 gap-6 sm:grid-cols lg:grid-cols-6  animate-fade-in-up delay-100">
            {[
              "technology",
